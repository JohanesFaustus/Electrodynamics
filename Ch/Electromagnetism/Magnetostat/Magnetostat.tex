...
Another defition can be started by multiplying both side with $dl$
\begin{equation*}
\end{equation*}
\begin{align*}
    \mathbf{J} d a_\perp \;d l & =  d \mathbf{I}\; d l         \\
    \mathbf{J}\;d\tau          & = \mathbf{I}\;d \mathbf{l}\\
    \mathbf{J}&= I \frac{d \mathbf{l}}{d\tau}
\end{align*}
where $d\mathbf{I} \rightarrow I \mathbf{\hat{I}}$ does not mean the change of current, but rather an infinitesimal piece of current.
This definition only holds for steady current.
