...
\begin{figure}[b]
    \centering
    \includegraphics[width=0.65\textwidth]{./Rss/Electromagnetism/Vector Analysis/SepVec}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.4\textwidth]{Rss/Electromagnetism/Vector Analysis/Spherical.png}
    \includegraphics[width=0.4\textwidth]{Rss/Electromagnetism/Vector Analysis/Cyl.png}
