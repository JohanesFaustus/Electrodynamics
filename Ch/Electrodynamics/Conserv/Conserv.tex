...
\end{equation*}
This theorem says that the work done on the charges by the electromagnetic force is equal to the decrease in energy remaining in the ﬁelds, less the energy that ﬂowed out through the surface.
From this, Poynting vector
\begin{equation*}
    \mathbf{S}\equiv\frac{1}{\mu_0}\mathbf{E}\times\mathbf{B}
\end{equation*}
is defined as the energy per unit time, per unit area, transported by the ﬁelds.
