...
\begin{equation*}
  ...
  =  \sum_{\mathbf{k},s} \left[ A_{\mathbf{k}s}(t) \frac{e^{i\mathbf{k} \cdot \mathbf{r}}}{\sqrt{V}} + A_{\mathbf{k}s}^*(t) \frac{e^{-i\mathbf{k} \cdot \mathbf{r}}}{\sqrt{V}} \right] \epsilon_{\mathbf{k}s}
\end{equation*}
...
The reason being that the electromagnetic field can written as a linear combination of the ladder operators.
...
Thus,
\begin{equation*}
  \alpha |\alpha\rangle = \alpha \sum_{n=0}^{\infty} c_n |n\rangle .
\end{equation*}
